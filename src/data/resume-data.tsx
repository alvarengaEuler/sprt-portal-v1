...
export const RESUME_DATA = {
  ...
  locationLink: "https://maps.app.goo.gl/fW2xUjkwNa9viMFMA",
  about:
  ...
  projects: [
    {
      title: "Whatsapp Link - Beta",
      techStack: ["Side Project", "TypeScript", "Next.js", "v.0.1"],
      description:
        "A basic platform that generate a direct link with a message for whatsapp.",
      logo: "",
      link: {
        label: "WP Link",
        href: "https://wp-link.vercel.app/",
      },
    },
    // {
    //   title: "Monito",
